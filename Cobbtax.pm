...
sub post_content()
{
	...
	$req->header("Cookie"=>"__utma=172939825.896068541.1423019657.1423026077.1423380420.4; __utmz=172939825.1423019657.1.1.utmcsr=(direct)|utmccn=(direct)|utmcmd=(none); BNES___utmt=wo4xucKvLUw2R6m7sZBOzu3kB/ZYQJvmAEWrRFCLi+piX3KltFG8nw==; __utmb=172939825.3.10.1423380420; __utmc=172939825; ASP.NET_SessionId=fmidfmxzx1asd3hwlmo0qira; BNES_ASP.NET_SessionId=tRpYhRiYC93wJoo2DM0+yQVXd2xvbFrtNO+RcTD3xyjUE3z9BTRavmK9PwdFpq5/YjHeFkffHCXKjG/4gmCGOiXcTYE+dCre; __utmt=1");
	$req->content($cont);
